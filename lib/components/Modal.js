...
export default class Modal extends React.Component {
    constructor(props) {
        ...
        this.handleGraphProperties = this.handleGraphProperties.bind(this);
    ...
    handleGraphProperties() {
        if(this.checkExpirationTimeAmount()) {
            ...
            this.props.changeGraphProperties(expires, editable, volatile, revisionable);
        }
    }
    handleGraphPermissions() {
        let manage = this.refs.manage.value;
        let read = this.refs.read.value;
        let write = this.refs.write.value;
        let subscribe = this.refs.subscribe.value;
        this.props.changeGraphPermissions(manage, read, write, subscribe);
    }
    handleNewNode(event) {
        if(this.checkLabelMinimumLength()) {
    ...
    handleNodePermissions() {
        ...
        let write = this.refs.write.value;
        let subscribe = this.refs.subscribe.value;
        this.props.changeNodePermissions(manage, read, write, subscribe);
    }
    handleNewEdge(event) {
    ...
    handleNewAttribute(event) {
        ...
        if(this.props.data.page == 1) {
            if(this.checkAttributeNamePattern('name') && this.checkMinimumLength('name', 'Attribute name', 1) && this.checkMaximumLength('name', 'Attribute name', 24)) {
    ...
    render() {
        ...
        if(model == 'addGraph') {
            ...
            component = <div className="modal">
                ...
                <button onClick={this.handleNewGraph} className="half">Add</button>
            </div>
            ...
            component = <div className="modal">
                ...
                <button onClick={this.props.closeModal} className="half danger">Cancel</button>
                <button onClick={this.handleExistingGraph} className="half">Change</button>
            </div>
        } else if(model == 'changeGraphProperties') {
            //changeGraphProperties
            let element = this.props.main;
            component = <div className="modal">
                <div className="label">
                    <span>Change Graph Properties</span>
                </div>
                {this.state.failMessages.length > 0 && <div className="warning">
                    <ul className="fail">
                        {this.state.failMessages.map((failMessage, key) => <li key={key}>{failMessage}</li>)}
                ...
                <button onClick={this.props.closeModal} className="half danger">Cancel</button>
                <button onClick={this.handleGraphProperties} className="half">Change</button>
            </div>
            ...
            component = <div className="modal">
                ...
                <div className="labeled dropdown wrapper">
                    <b>Manage</b>
                    <select ref="manage" defaultValue={element.permissions.manage}>
                        {[true, false].map((option, key) =>
                            <option key={key} value={option}>{option.toString()}</option>
                        )}
                    </select>
                    ...
                    <div className="labeled dropdown wrapper">
                        <b>Read</b>
                        <select ref="read" defaultValue={element.permissions.read}>
                            {[true, false].map((option, key) =>
                                <option key={key} value={option}>{option.toString()}</option>
                            )}
                        </select>
                    ...
                    <div className="labeled dropdown wrapper">
                        <b>Write</b>
                        <select ref="write" defaultValue={element.permissions.write}>
                            {[true, false].map((option, key) =>
                                <option key={key} value={option}>{option.toString()}</option>
                            )}
                        </select>
                    ...
                    <div className="labeled dropdown wrapper">
                        <b>Subscribe</b>
                        <select ref="subscribe" defaultValue={element.permissions.subscribe}>
                            {[true, false].map((option, key) =>
                                <option key={key} value={option}>{option.toString()}</option>
                            )}
                        </select>
                ...
                <button onClick={this.props.closeModal} className="half danger">Cancel</button>
                <button onClick={this.handleGraphPermissions} className="half">Change</button>
            </div>
            ...
            component = <div className="modal">
                ...
                <button onClick={this.props.closeModal} className="half danger">Cancel</button>
                <button onClick={this.handleNodePermissions} className="half">Change</button>
            </div>
            ...
            component = <div className="modal">
                ...
                <button onClick={this.handleNewAttribute} className={'half' + (page == 1 ? '' : ' hidden') + (attributeTypes.includes(attributeType) ? ' arrow' : '')}>{attributeTypes.includes(attributeType) ? 'Next' : 'Add'}</button>
                <button onClick={this.handleNewAttribute} className={(page == pageLimit ? '': 'arrow') + (page == 1 ? ' hidden' : '')}>{page == pageLimit ? 'Add': 'Next'}</button>
            </div>
            ...
            component = <div className="modal">
                ...
                <button onClick={this.props.closeModal} className={'half danger' + (page == 1 ? '' : ' hidden')}>Cancel</button>
                <button onClick={this.handleExistingAttribute} className={'half' + (page == 1 ? '' : ' hidden') + (attributeTypes.includes(attributeType) ? ' arrow' : '')}>{attributeTypes.includes(attributeType) ? 'Next' : 'Change'}</button>
                <button onClick={this.handleExistingAttribute} className={(page == pageLimit ? '': 'arrow') + (page == 1 ? ' hidden' : '')}>{page == pageLimit ? 'Change': 'Next'}</button>
            </div>
        } else {
            //Nothing to render
        }
