    ...
    render() {
        ...
        if(scope) {
            ...
            if(scope.category == 'edge') {
                ...
                this.props.data.edges.forEach(function(item) {
                    if(item.id == scope.id) {
                        edgeType = item.type;
                    }
                });
            ...
            let permissionList = scope.category == 'node' || scope.category == 'graph' ? [
                {
                    label: 'owner',
                    value: element.permissions.owner
                },
                {
                    label: 'subscribers',
                    value: element.permissions.subscribers
                },
                {
                    label: 'context',
                    value: element.permissions.context
                },
                {
                    label: 'others',
                    value: element.permissions.others
                }
            ] : [];
