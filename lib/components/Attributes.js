    ...
    render() {
        return(
            <div className="attributes">
                ...
                <Sortable onSort={this.handleSort} className="vertical-container" direction="vertical" key={(Math.floor(Math.random() * 100)) + 'x' + (Math.floor(Math.random() * 100))}>
                    {this.props.list.map((item, key) => item.name != 'id' &&
