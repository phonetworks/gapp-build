    ...
    render() {
        return(
            <ul className="settings">
                ...
                <li key={key}>
                    <b className={item.hasOwnProperty('value') ? 'identifier' : ''}>{item.label}</b>
                    {item.hasOwnProperty('value') ? item.value.toString() : ''}
