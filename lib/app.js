...
class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            graph: {
                ...
                edges: [
                    {id: 0, type: 'read', label: 'Post', from: 3, to: 5, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 1, type: 'read', label: 'Create', from: 4, to: 5, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 2, type: 'subscribe', label: 'Follow', from: 1, to: 4, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 3, type: 'subscribe', label: 'Join', from: 2, to: 4, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 4, type: 'subscribe', label: 'Status', from: 0, to: 3, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 5, type: 'mention', label: 'Status', from: 0, to: 0, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 6, type: 'notify', label: 'Status', from: 2, to: 2, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}},
                    {id: 7, type: 'mention', label: 'Comment', from: 1, to: 5, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, notifier: false, subscriber: false, formative: false}}
                ]
            },
            modal: false,
            options: false
    ...
    changeProperties(category, id, type) {
        this.setState({
            modal: {
