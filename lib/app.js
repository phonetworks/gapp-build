    ...
    constructor(props) {
        ...
        this.state = {
            ...
            graph: {
                ...
                edges: [
                    {id: 0, type: 'read', label: 'Post', from: 3, to: 5, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 1, type: 'read', label: 'Create', from: 4, to: 5, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 2, type: 'subscribe', label: 'Follow', from: 1, to: 4, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 3, type: 'subscribe', label: 'Join', from: 2, to: 4, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 4, type: 'subscribe', label: 'Status', from: 0, to: 3, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 5, type: 'mention', label: 'Status', from: 0, to: 0, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 6, type: 'notify', label: 'Status', from: 2, to: 2, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 7, type: 'mention', label: 'Comment', from: 1, to: 5, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]}
                ]
            },
            modal: false,
            options: false,
    ...
    addEdge(type, label, from, to, copies) {
        ...
        for(let head of copies.heads) {
            ...
            edges.push({
                ...
                label: label,
                from: from,
                smooth: {type: 'curvedCW', roundness: curvedness}
                to: head,
                master: id,
                chosen: {
                    edge: changeStyle['edge']
