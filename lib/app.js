        ...
        this.state = {
            ...
            graph: {
                ...
                edges: [
                    ...
                    {id: 5, type: 'subscribe', label: 'Reply', from: 0, to: 3, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                    {id: 6, type: 'mention', label: 'Include', from: 3, to: 0, chosen: {edge: changeStyle['edge']}, properties: {binding: false, multiplicable: true, persistent: true, consumer: true, formative: false}, attributes: [{id: 0, name: 'id', type: 'id', required: true, mutations: {}, constraints: {}}]},
                ]
            },
            modal: false,
            options: false,
