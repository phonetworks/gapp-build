...
class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            graph: {
                nodes: [
                    {id: 0, type: 'actor', label: 'Actor #1', image: 'lib/images/icons/actor-node.svg', shape: 'image', properties: {expires: 0, editable: true, volatile: false, revisionable: false}, attributes: []},
                    {id: 1, type: 'actor', label: 'Actor #2', image: 'lib/images/icons/actor-node.svg', shape: 'image', properties: {expires: 0, editable: true, volatile: false, revisionable: false}, attributes: []},
                    {id: 2, type: 'actor', label: 'Actor #3', image: 'lib/images/icons/actor-node.svg', shape: 'image', properties: {expires: 0, editable: true, volatile: false, revisionable: false}, attributes: []},
                    {id: 3, type: 'object', label: 'Object #1', image: 'lib/images/icons/object-node.svg', shape: 'image', properties: {expires: 0, editable: true, volatile: false, revisionable: false}, attributes: []},
                    {id: 4, type: 'object', label: 'Object #2', image: 'lib/images/icons/object-node.svg', shape: 'image', properties: {expires: 0, editable: true, volatile: false, revisionable: false}, attributes: []},
                    {id: 5, type: 'graph', label: 'Graph #1', image: 'lib/images/icons/graph-node.svg', shape: 'image', properties: {expires: 0, editable: true, volatile: false, revisionable: false}, attributes: []}
                ],
                edges: [
